...
<div className='bg-black  text-white'>
    <h1 className='text-center p-[2em] text-3xl font-bold'>EARPHONES</h1>
</div>

<div className='container md:flex grid grid-cols-1 gap-9 justify-between mx-auto mt-[4em] px-5'>
                <div className='w-full h-full bg-gray-100 text-center mx-auto p-10'>
                    <img src={earphone} alt='Yone' className='object-contain mx-auto text-center md:full ' />
                </div>
                <div className=' w-full rounded-xl'>
                    <div className='md:px-20 px-12 md:mt-24'>
                        ...
                        <Link to="/eardetails" className="mt-10 p-2 mb-[4em] bg-lightDeep md:text-white text-xl font-semibold">
                            SEE PRODUCT
                        </Link>
                    </div>
                </div>
