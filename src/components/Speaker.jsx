...
import speake from '../assets/speaker.png'
    ...
    return (
        <div>
            ...
            <div className='bg-black  text-white'>
                <h1 className='text-center p-[2em] text-3xl font-bold'>SPEAKER</h1>
            </div>

            <div className='container md:flex grid grid-cols-1 gap-9 justify-between mx-auto mt-[4em] px-5'>
                <div className='w-full h-full bg-gray-100 text-center p-10 mx-auto'>
                    <img src={speaker} alt='Yone' className='md:h-96 object-contain mx-auto text-center ' />
                </div>
                <div className=' w-full rounded-xl'>
                    <div className='md:px-20 px-12 md:mt-17'>
                        <small className='text-lightDeep md:w-full'> NEW PRODUCT</small>
                        <p className='font-bold  text-4xl w-full  '>
                            XX99 Mark II Headphones
                        </p>
                        <div className="  md:w-full mt-4 mb-7">
                            The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.
                        </div>

                        <Link to="/speakdetails" className=" p-2 mb-[4em] bg-lightDeep md:text-white text-xl font-semibold">
                            SEE PRODUCT
                        </Link>
                    </div>
                </div>
            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 gap-9 justify-between mx-auto mt-[5em] mb-[7em] px-5'>
            <div className=' w-full  bg-gray-100 text-center mx-auto md:hidden block'>
                    <img src={speakk} alt='Headphone' className='object-cover mx-auto text-center ' />
                </div>
                <div className='w-full rounded-xl'>
                ...
                <div className=' w-full  bg-gray-100 text-center mx-auto md:block hidden'>
                    <img src={speakk} alt='Headphone' className='object-cover mx-auto text-center ' />
                </div>
            </div> 
            ...
            <div className="container mx-auto px-4   items-center justify-center  mt-20 mb-[5em]">
                <div className="flex flex-wrap -mx-4 justify-center">
                    ...
                    <div className="w-full md:w-1/3 px-4 mb-4 relative flex justify-center">
                        <img src={speake} alt='speaker' className='mx-auto text-center absolute top-0' />
                        <div className="max-w-sm rounded w-[100%] overflow-hidden bg-gray-100 mt-[6em] pt-[3em]">
                            <div className="px-6 py-4 mt-5 text-center">
