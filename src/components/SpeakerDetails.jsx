    ...
    return (
        <div>
            ...
            <div className='container mx-auto mt-[4em] px-3'>
                <a href='/speaker' className='text-black '>Go Back</a>
                ...
                <div className='md:flex grid grid-flow-cols-1 justify-between mt-[4em]'>
                    <div className='w-full'>
                        <div className='px-5 py-3'>
                            <img src={Bitmap01} alt='human' className=' object-cover' />
                        </div>
                        <div className='w-full px-5 py-1'>

                            <img src={Bitmap02} alt='human' className='w-full object-cover' />
                        </div>
                    </div>
                    <div className='w-full p-3'>
                        <img src={Bitmap11} alt='human' className='object-cover md:h-full' />
                    </div>
                </div>
            </div>
